...
//{
//    public class PolynomialLSTransformation : GpsToWorldTransformation
//    {
//        static int OrderOfPolynomial = 2;
//        PolynomialRegression poly_x = null;
//        PolynomialRegression poly_y = null;
//        PolynomialRegression poly_z = null;


//        PolynomialLeastSquares ls = new PolynomialLeastSquares()
//        {
//            Degree = OrderOfPolynomial
//        };

//        public override bool TransformationAvailable => NumberOfRecords > minNumberOfPointToSolve && poly_x != null && poly_y != null;
...
//                        out_x[idx] = new double[] { r.ArPosition.x, r.ArPosition.y };
//                        in_XY[idx] = new double[] { r.GpsPosition.Longitude, r.GpsPosition.Latitude };
//                        idx++;
//                    }
//                    regression = ls.Learn(in_XY, out_xy);
...
//                idx++;
//            }
//            double[][] out_xy = regression.Transform(in_XY);
//            List<Vector3> output = new List<Vector3>();
//            foreach (double[] r in out_xy)
//                output.Add(new Vector3((float)r[0], (float)r[1]));
//            return output;
//        }

//        public override List<Vector3> TransformGpsToWorld(List<Location> gpsLocations, List<Vector3> arLocations, out double error, out double[] r2)
//        {
//            error = 0;
//            r2 = new double[] { };
//            if (!TransformationAvailable)
...
//            double[][] out_xy = new double[arLocations.Count][];
...
//            {
//                out_xy[idx] = new double[] { v.x, v.y };
//                idx++;
//            }

//            double[][] out_xy_prediction = regression.Transform(in_XY);
//            error = new SquareLoss(out_xy).Loss(out_xy_prediction);
//            r2 = regression.CoefficientOfDetermination(in_XY, out_xy);
...
//            double[][] out_xy = regression.Transform(in_XY);
//            return new Vector3((float)out_xy[0][0], (float)out_xy[0][1]);
//        }
//    }
//}
